...
def test_efficiency():
	...
	print("测试方案1 (简洁版)...")
	time_v1 = simulate("t1", Unlocks, {Items.Carrot: 1000000000000000000000000000, Items.Hay: 1000}, {"max_runs": test_runs}, 42, 32)
	
	print("测试方案2 (多无人机版)...")
	time_v2 = simulate("t2", Unlocks, {Items.Carrot: 1000000000000000000000000000, Items.Hay: 1000}, {"max_runs": test_runs}, 42, 32)
	
	pumpkins_per_harvest = 12 * 12 * 12
